...
export default class CreateSleepGoal extends Component {
  ...
  // e or element is value of updated state
  onChangeUsername(e) {
    this.setState({
      // target is the text box and value is the user's input
  ...
  onSubmit(e) {
    ...
    // logs value of sleep goal, renders value of sleepgoal, and passes value to JSX
    console.log(sleepgoal);

    // HTTP call to add new sleep goal entry to MongoDB
