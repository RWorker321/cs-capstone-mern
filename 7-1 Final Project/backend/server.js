...
// cors or Cross-Origin Resource Sharing for resource sharing of Port 5000(server) and localhost 3000(App)
app.use(cors());
// express.json allows us to parse json for sending/recieving
app.use(express.json());

// Database uri to MongoDB Atlas. Pass in URI stored in .env
